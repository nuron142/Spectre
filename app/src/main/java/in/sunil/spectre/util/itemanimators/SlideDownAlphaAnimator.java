...
public class SlideDownAlphaAnimator extends DefaultAnimator<SlideDownAlphaAnimator> {
    ...
    public ViewPropertyAnimatorCompat addAnimation(RecyclerView.ViewHolder holder) {
        return ViewCompat.animate(holder.itemView).translationY(0).alpha(1)
                .setDuration(getMoveDuration()).setInterpolator(new LinearInterpolator());
    }
    ...
    public ViewPropertyAnimatorCompat removeAnimation(RecyclerView.ViewHolder holder) {
        ...
        return animation.setDuration(getRemoveDuration()).alpha(0)
                .translationY(-holder.itemView.getHeight()).setInterpolator(getInterpolator());
    }

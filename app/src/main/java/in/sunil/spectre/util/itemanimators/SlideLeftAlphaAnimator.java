...
public class SlideLeftAlphaAnimator extends DefaultAnimator<SlideLeftAlphaAnimator> {
    ...
    public ViewPropertyAnimatorCompat addAnimation(RecyclerView.ViewHolder holder) {
        return ViewCompat.animate(holder.itemView).translationX(0).alpha(1)
                .setDuration(getMoveDuration()).setInterpolator(getInterpolator());
    }
    ...
    public ViewPropertyAnimatorCompat removeAnimation(RecyclerView.ViewHolder holder) {
        ...
        return animation.setDuration(getRemoveDuration()).alpha(0)
                .translationX(holder.itemView.getWidth()).setInterpolator(getInterpolator());
    }
